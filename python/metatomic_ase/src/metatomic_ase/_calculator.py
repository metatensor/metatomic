    ...
    def __init__(
        ...
        *,
        ...
        :param uncertainty_threshold: threshold for the atomic energy uncertainty in eV.
            ...
            it.
        :param neighbor_skin: skin distance in Å for the Verlet list in the neighbor
            list calculation. By setting this parameter, you are extending the cutoff
            radius of the neighbor list calculation by `neighbor_skin` Å. The extended
            cutoff helps reduce the frequency of neighbor list updates, because when the
            maximun atomic displacement is smaller than :math:`(r_{skin} / 2)`, the
            neighbor list can still ensure that all neighbors within
            :math:`(r_{cutoff})` are included. The default value is 2.0 Å.
        """
        super().__init__()
