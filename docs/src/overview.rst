...
5. the engine asks the model for the required neighbor lists;
   ...
   .. tip::
        ...
        :py:func:`AtomisticModel.requested_neighbor_lists`. This function is
        also exported to TorchScript and can be called from C++ with
        :cpp:func:`torch::jit::Module::run_method`.
...
7. the engine asks the model for the required extra input data (if any) ;
   ...
   .. tip::
        ...
        This should be done by calling
        :py:func:`AtomisticModel.requested_inputs`. This function is also
        exported to TorchScript and can be called from C++ with
        :cpp:func:`torch::jit::Module::run_method`.
