"""Simple lexer for syntax highlighting LAMMPS input scripts"""
...
class LAMMPSLexer(RegexLexer):
    ...
    tokens = {
        ...
        "keywords": [(words(LAMMPS_COMMANDS, suffix=r"\b", prefix=r"^\s*"), Keyword)],
        "variable": [
            (r"[^\}]+", Name.Variable),
            (r"\}", Name.Variable, "#pop"),
        ],
        ...
        "modify_cmd": [(r"[\w_\-\.\[\]]+", Name.Variable.Identifier), default("#pop")],
        "fix": [
        ...
        "region": [(r"[\w_\-\.\[\]]+", Name.Variable.Identifier), default("#pop")],
        "variable_cmd": [
            (r"[\w_\-\.\[\]]+", Name.Variable.Identifier),
            default("#pop"),
        ],
        "group": [(r"[\w_\-\.\[\]]+", Name.Variable.Identifier), default("#pop")],
        "change_box": [(r"[\w_\-\.\[\]]+", Name.Variable.Identifier), default("#pop")],
        "create_box": [
            (r"[\w_\-\.\[\]]+", Name.Variable.Identifier),
            (r"\s+", Whitespace, "group_id"),
            default("#pop"),
        ],
        "id_cmd": [(r"[\w_\-\.\[\]]+", Name.Variable.Identifier), default("#pop")],
        "ndx_cmd": [(r"[\w_\-\.\[\]]+", Name.Variable.Identifier), default("#pop")],
        "jump_cmd": [(r"[\w_\-\.\[\]]+", Literal.String.Char), default("#pop")],
        "kim_cmd": [(r"[\w_\-\.\[\]]+", Literal.String.Single), default("#pop")],
        "write_dump": [(r"[\w_\-\.\[\]]+", Name.Variable.Identifier), default("#pop")],
        "group_id": [(r"[\w_\-\.\[\]]+", Name.Variable.Identifier), default("#pop:2")],
    }
