...
impl Device {
    ...
    /// Check wether a dlpack device is valid to use with this model device.
    pub fn is_valid(&self, device: dlpk::DLDevice) -> bool {
        // this should probably handle the "Host" and "Managed" variants, but
        // should be enough for now.
        return device.device_type == self.0;
    }
}
